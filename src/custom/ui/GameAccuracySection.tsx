...
export const GameAccuracySection: React.FC<GameAccuracySectionProps> = ({
  ...
  return (
    <div className="intransitive-accuracy-card">
      ...
      {/* Main Split Layout: Left = Evaluation Curve, Right = Player Performance (Vertical Stack) */}
      <div className="intransitive-accuracy-split-layout">
        {/* Left Column: Interactive Evaluation Graph & Turning Points */}
        <div className="intransitive-accuracy-left-col">
        ...
        {/* Right Column: Player Performance Cards (Vertically Stacked Top-to-Bottom) */}
        <div className="intransitive-accuracy-right-col">
          {/* Blue Player Card */}
